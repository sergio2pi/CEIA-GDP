...
\titulo{Visión artificial para la identificación de
frutos de duraznero
} 
...
\fechaFINALPlan{6 de Agosto de 2024} 	%Fecha de final de cursada de GdP
...
\begin{flushright}
Buenos Aires, 18 de Junio de 2024.\fechaInicioName
\end{flushright}
...
Contar de forma manual la cantidad frutos que posee un árbol a campo resulta una tarea laboriosa, lenta y propensa a errores. No obstante, conocer estos datos tiene diversas aplicaciones que por su dificultad no están siendo abordadas. Para un productor, por ejemplo, saber la cantidad de frutos que posee una muestra de su lote al momento del raleo \footnote{Descarte de una parte de los frutos para que los restantes tomen más nutrientes de la planta y puedan alcanzar tamaño comercial} le permite calcular la intensidad a aplicar. Además, al momento de la cosecha, le permite tener una estimación de su producción.
...
Por otro lado, los algoritmos a desarrollar resultan una herramienta muy útil obteniendo un gran volumen de datos que serviran para 
vincularlos con diferentes características de nuestro interés como:
...
El propósito de este proyecto es desarrollar un sistema informático capaz de detectar y contar los frutos de un duraznero en el árbol a partir de imagenes tomadas por una cámara 2D.
...
\begin{itemize}
	\item Procesamiento de imagenes en blano y negro.
...
\begin{itemize}
	...
	\item Un ordenador com placa de gráfica dedicada.
	\item Banco de imagenes de campo reales para el entrenamiento del sistema.
	\item No se invertirá en hardware
	\item No se espera una precision del 100 \%. Se definirá un margen aceptable.
\end{itemize}
